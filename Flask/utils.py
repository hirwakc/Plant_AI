disease_dic = {
    ...
    'Apple___Black_rot': """  <br/>Disease: Black Rot<br/>
        ...
        <br/>5. Be sure to remove the stumps of any  trees you cut down. Dead stumps can be a source of spores.""",
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ Disease: Grey Leaf Spot<br/>
        ...
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. In order to best prevent and manage  leaf spot, the overall approach is to reduce the rate of disease growth and expansion.
